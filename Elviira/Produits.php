    ...
    <div id="wrapper">
        ...
        <nav id="nav">
            <ul class="links">
                ...
                <li class="active"><a href="Produits.php?Page=0">Produits</a></li>
                ...
                <div class="pagination">
                    ...
                    { 
                        ...
                        {  //Mettre un +1 dans le deuxième echo car sinon, cela commence de 0 et c'est pas joli joli
                            ?>
                            <a href="Produits.php?Page=<?php echo $i; ?>" class="page active"><?php echo $i+1; ?></a>
                            <?php
                        }
                        else
                        {
                            ?>
                            <a href="Produits.php?Page=<?php echo $i; ?>" class="page"><?php echo $i+1; ?></a>
                            <?php
                        }
